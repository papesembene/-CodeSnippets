                ...
                <div class="px-6 pb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="code-container relative">
                            <button class="copy-btn inline-flex items-center px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors duration-200">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Code pour la copie -->
                            <code style="display: none;"><?= htmlspecialchars($snippet->getCodeContent()) ?></code>
                        </div>
                    </div>
                </div>
